...
class _Random_BodyState extends State<Random_Body> {
  ...
  String _user1name, _user2name;

  String _stranger;
  String _strangername;
  IO.Socket socket;
  String roomid;
      ...
      (data) {
        setState(
          () {
            _user1 = data['user1'];
            _user2 = data['user2'];
            _user1name = data['user1name'];
            _user2name = data['user2name'];

            // print("here");
            if (_user1 != _user2) {
              _stranger = (_user1 == user_id ? (_user2) : (_user1));
              _strangername = (_user1 == user_id ? (_user2name) : (_user1name));
  ...
  void _handlePrivateRoom() async {
    ...
    socket.emit('privateRoom',
        {"user": prefs.getString('userId'),"username": prefs.getString('randUser')});
  }
